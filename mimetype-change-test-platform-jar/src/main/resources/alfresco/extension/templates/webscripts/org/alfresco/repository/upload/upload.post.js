// ******************************************
// DGCloud: Code copied from 5.2.a-EA version
// ******************************************
...
function main()
{
   try
   {
      ...
      var updateNodeRef = null,
         majorVersion = false,
         // DGCloud: DGCloud: fix for the extention and mimetype change on New version upload
      ...
      if (updateNodeRef !== null)
      {
         ...
         if (updateNameAndMimetype)
         {
             ...
             // DGCloud: DGCloud: fix for the extention and mimetype change on New version upload
             // Ignores the name change, as this is going to be adjusted by the fix from
             // https://github.com/keensoft/alfresco-summit-2014/tree/master/10-enhancements/08-rename-on-change-ext/rename-on-change-ext-repo
